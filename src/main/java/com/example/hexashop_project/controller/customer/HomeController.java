...
public class HomeController {
    ...
    public String men(Model model, @RequestParam(defaultValue = "0") int page) {
        ...
        Page<Product> productPage = productService.getProductsByCategory(1, PageRequest.of(page, 8, Sort.by(Sort.Direction.DESC, "id")));
        Page<Product> casualProducts = productService.getProductsByCategory(13, PageRequest.of(page, 8, Sort.by(Sort.Direction.DESC, "id")));
    ...
    public String women(Model model, @RequestParam(defaultValue = "0") int page) {
    	...
    	Page<Product> productPage = productService.getProductsByCategory(2, PageRequest.of(0, 8, Sort.by(Sort.Direction.DESC, "id")));
        Page<Product> casualProducts = productService.getProductsByCategory(31, PageRequest.of(0, 8, Sort.by(Sort.Direction.DESC, "id")));
    ...
    public String getLatestWomenAjax(@RequestParam(defaultValue = "0") int page, Model model) {
        Page<Product> productPage = productService.getProductsByCategory(2, PageRequest.of(page, 8, Sort.by(Sort.Direction.DESC, "id")));
        model.addAttribute("productPage", productPage);
        
        // Chỉ trả về đoạn HTML có tên fragment là 'latestFragment' trong file women.html
    ...
    public String getCasualWomenAjax(@RequestParam(defaultValue = "0") int page, Model model) {
        Page<Product> casualProducts = productService.getProductsByCategory(31, PageRequest.of(page, 8, Sort.by(Sort.Direction.DESC, "id")));
        model.addAttribute("casualProducts", casualProducts);
    ...
    public String kids(Model model, @RequestParam(defaultValue = "0") int page) {
        // Kids Latest & Casual 
    	Page<Product> productPage = productService.getProductsByCategory(3, PageRequest.of(0, 8, Sort.by(Sort.Direction.DESC, "id")));
        Page<Product> casualProducts = productService.getProductsByCategory(18, PageRequest.of(0, 8, Sort.by(Sort.Direction.DESC, "id")));
    ...
    public String getLatestKidsAjax(@RequestParam(defaultValue = "0") int page, Model model) {
        Page<Product> productPage = productService.getProductsByCategory(3, PageRequest.of(page, 8, Sort.by(Sort.Direction.DESC, "id")));
        model.addAttribute("productPage", productPage);
    ...
    public String getCasualKidsAjax(@RequestParam(defaultValue = "0") int page, Model model) {
        Page<Product> casualProducts = productService.getProductsByCategory(18, PageRequest.of(page, 8, Sort.by(Sort.Direction.DESC, "id")));
        model.addAttribute("casualProducts", casualProducts);
